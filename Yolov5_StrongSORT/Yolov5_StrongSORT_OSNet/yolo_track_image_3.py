...
class Yolov5Detector:
    ...
    def dectshow(self,color_image,depth_image, color_intr):
        main(opt,depth_image,color_image,color_intr)
...
def run(
    ...
    try:
        ...
        pub_box = rospy.Publisher("/multi_box_command",Float32MultiArray,queue_size=10)
                ...
                if det is not None and len(det):
                    ...
                    if len(outputs[i]) > 0:
                        ...
                        for j, (output, conf) in enumerate(zip(outputs[i], confs)):
                            ...
                            cv2.drawMarker(depth, (d1, d2), (255, 0, 0))
                        ...
                        pub_box.publish(box_array_forPublish)
...
def main(opt,depth_image,color_image,color_intr):
