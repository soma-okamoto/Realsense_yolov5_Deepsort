...
class Yolov5Detector:
    ...
    def ImageCallback(self, depthdata, colordata):
        ...
        self.depth_image = np.asanyarray(depth_image)
        self.color_image = np.asanyarray(color_image)
        print(color_image)
...
def run(
    ...
    try:
        ...
        while True:
            ...
            color_image,depth_image = detector.ImageCallback()
                        ...
                        if len(outputs[i]) > 0:
                            ...
                            for j, (output, conf) in enumerate(zip(outputs[i], confs)):
                                ...
                                if save_img or save_crop or view_img:  # Add bbox to image
                                    ...
                                    object2base = CoordinateTransformation(x,y,zDepth,color_intr)
